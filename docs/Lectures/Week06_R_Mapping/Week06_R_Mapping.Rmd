...
See [here](https://leaflet-extras.github.io/leaflet-providers/preview/index.html) for the complete list of the third-oarty basemaps
...
```{r}
setwd("F:\\Clark_Universiy\\Clark_Teaching\\Git_Repo\\ssj-30262")
parks = read.csv('.\\docs\\Lectures\\Week06_R_Mapping\\parks.csv')
head(parks)
```
...
library(sf)
setwd('F:/Clark_Universiy/Clark_Teaching/Git_Repo/ssj-30262')
water_quality = read_sf('.\\docs\\Lectures\\Week06_R_Mapping\\water_quality_station\\worcester_station.shp')
...
```{r}
parking_line = read_sf('F:\\Clark_Universiy\\Clark_Teaching\\Git_Repo\\ssj-30262\\docs\\Lectures\\Week06_R_Mapping\\winter_ban\\Winter_Parking_Ban.shp')
